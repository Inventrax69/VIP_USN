...
public class UpdateRequest {
    ...
    static final String EXTRA_COMMAND = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_COMMAND";
    private static final String EXTRA_VCS = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_VCS";
    private static final String EXTRA_CONFIRM_DOWNLOAD = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_CONFIRM_DOWNLOAD";
    private static final String EXTRA_PHASE = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_PHASE";
    private static final String EXTRA_DS = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_DS";
    private static final String EXTRA_CONFIRM_INSTALL = "com.commonsware.cwac.updater.EXTRA_CONFIRM_INSTALL";
    private static final String EXTRA_UPDATE_URL = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_UPDATE_URL";
    private static final String EXTRA_INSTALL_URI = "com.inventrax.karthikm.merlinwmscipher_vip_rdc.Services.appupdate.EXTRA_INSTALL_URI";
